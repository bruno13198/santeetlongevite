// Migration one-shot : copie les termes de recherche déjà connus
// (jusqu'ici codés en dur dans import-etudes.js) vers la colonne
// terme_recherche de la table aliments.
...
async function main() {
  ...
  for (const { slug, terme } of TERMES_CONNUS) {
  ...
  console.log(`\n${succes} termes migrés avec succès, ${echecs} erreurs.`);
  console.log('Terminé.');
}
